...
//Name: Wall-E Arm.ma
//Last modified: Wed, Sep 20, 2017 05:25:31 PM
//Codeset: UTF-8
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.017760775707675 3.5166142060906429 32.01309163292445 ;
	setAttr ".r" -type "double3" -7.5383527289658172 374.1999999999922 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DF422BB5-4640-DE6F-A46D-52B507FCA7D0";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 16.738585877698867;
...
createNode transform -s -n "top";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.04281300823766454 1000.1 0.93118292916920797 ;
...
createNode transform -n "pCube5";
	...
	setAttr ".t" -type "double3" -0.18945717539372914 0 13.222623783008698 ;
...
createNode transform -n "pCylinder4";
	...
	setAttr ".t" -type "double3" -0.20518936357211381 0.036923407448121726 13.311094133066652 ;
...
createNode transform -n "pCube7";
	...
	setAttr ".t" -type "double3" -0.74446529369403791 2.0743735000937393 17.761608051891955 ;
...
createNode transform -n "pCube9";
	...
	setAttr ".t" -type "double3" -0.072801052047145376 2.0694061485622246 11.583101636273424 ;
...
createNode transform -n "pCube10";
	...
	setAttr ".t" -type "double3" -0.072801052047145376 -2.0521577715500512 11.583101636273424 ;
	setAttr ".s" -type "double3" 0.69363351800979334 0.78600398945629002 0.69363351800979334 ;
	setAttr ".rp" -type "double3" -1.7881393432617188e-07 0 5.3757232137731759 ;
	setAttr ".sp" -type "double3" -1.7881393432617188e-07 0 5.3757232137731759 ;
...
createNode transform -n "pCube11";
	...
	setAttr ".t" -type "double3" -0.74446529369403791 -2.0575894610500995 17.761608051891955 ;
	setAttr ".s" -type "double3" 0.3921179819078015 2.4909140545268329 2.9828765535048452 ;
...
createNode transform -n "pCylinder5";
	...
	setAttr ".t" -type "double3" -0.60976146201439851 1.7251563847201639 16.205622378723536 ;
...
createNode transform -n "pCylinder6";
	...
	setAttr ".t" -type "double3" -0.60976146201439851 -1.7614589402772705 16.205622378723536 ;
	setAttr ".s" -type "double3" 0.22194358216638868 1.4198325477629048 0.22194358216638868 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "79F7AB5A-FF4C-BB2C-CBD7-63B24AA841B4";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "309364ED-B34D-F01E-3797-CABBDBE7C46D";
createNode displayLayer -n "defaultLayer";
	rename -uid "222E16E1-8D47-77B4-B197-ED9475C52C7F";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CD4C11FD-B540-18B5-5CAA-A9B8F0DA1682";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "E20D2535-5D49-BEEE-64B5-E18FAF490C98";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9170B70D-C14A-6674-DE5E-0BA0723F8061";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "223C519D-A54E-F008-C27C-3BB527EDDF39";
...
connectAttr "polyMergeVert17.out" "pCubeShape2.i";
...
connectAttr "polyExtrudeFace5.out" "pCube9Shape.i";
connectAttr "groupId13.id" "pCube9Shape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "pCube9Shape.iog.og[0].gco";
connectAttr "polyExtrudeFace7.out" "pCube10Shape.i";
connectAttr "groupId14.id" "pCube10Shape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "pCube10Shape.iog.og[0].gco";
connectAttr "polyTweakUV20.uvtk[0]" "pCube10Shape.uvst[0].uvtw";
connectAttr "polyExtrudeFace8.out" "pCubeShape11.i";
connectAttr "polyTweakUV21.uvtk[0]" "pCubeShape11.uvst[0].uvtw";
...
connectAttr "|pCube9|polySurfaceShape2.o" "groupParts9.ig";
...
connectAttr "pCube10Shape.wm" "polyExtrudeEdge14.mp";
connectAttr "polyExtrudeEdge14.out" "polyExtrudeEdge15.ip";
connectAttr "pCube10Shape.wm" "polyExtrudeEdge15.mp";
