...
//Name: Wall-E Arm.ma
//Last modified: Sat, Sep 30, 2017 04:45:57 PM
//Codeset: UTF-8
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 13.017006038576842 1.7485337880059342 18.024786127098839 ;
	setAttr ".r" -type "double3" 189.86164726098312 -1905.7999999955227 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DF422BB5-4640-DE6F-A46D-52B507FCA7D0";
	setAttr -k off ".v" no;
	setAttr ".pze" yes;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 17.071585603122077;
...
createNode mesh -n "armShape" -p "arm";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.12707436829805374 0.50167328119277954 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
