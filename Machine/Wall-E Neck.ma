...
//Name: Wall-E Neck.ma
//Last modified: Wed, Sep 20, 2017 03:45:31 PM
//Codeset: UTF-8
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.143423518623349 -5.6781046320396253 24.374727929377325 ;
	setAttr ".r" -type "double3" 177.26164741497786 4149.7999999972571 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "D6D3141F-CF4F-4972-12FB-03AC962BD9F5";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 24.667189819285198;
...
createNode mesh -n "pCylinder5Shape" -p "pCylinder5";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.53373539447784424 0.8753507137298584 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 18 ".pt";
	setAttr ".pt[69]" -type "float3" 0 0 -0.083432704 ;
	setAttr ".pt[421]" -type "float3" -0.21052542 0 -0.12604494 ;
	setAttr ".pt[422]" -type "float3" -0.15622213 0 0.13659565 ;
	setAttr ".pt[423]" -type "float3" 0.16993921 0 -0.074722044 ;
	setAttr ".pt[424]" -type "float3" 0.19618264 0 0.17103083 ;
	setAttr ".pt[431]" -type "float3" -0.10872882 0 -0.10019413 ;
	setAttr ".pt[432]" -type "float3" -0.04375907 0 0.067197993 ;
	setAttr ".pt[436]" -type "float3" 0.010093933 0 0.058437631 ;
	setAttr ".pt[437]" -type "float3" 0.12591647 0 -0.12372197 ;
	setAttr ".pt[441]" -type "float3" -0.19852948 0 -0.10982326 ;
	setAttr ".pt[442]" -type "float3" -0.12896785 0 0.19745721 ;
	setAttr ".pt[446]" -type "float3" 0.15490799 -0.0069108112 0.14939913 ;
	setAttr ".pt[447]" -type "float3" 0.17689833 0 -0.12125978 ;
	setAttr ".pt[451]" -type "float3" -0.17671622 0 -0.10496413 ;
	setAttr ".pt[452]" -type "float3" -0.15801734 0 0.21700761 ;
	setAttr ".pt[456]" -type "float3" 0.20035744 0 0.1794004 ;
	setAttr ".pt[457]" -type "float3" 0.16366942 0 -0.074770264 ;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode lightLinker -s -n "lightLinker1";
	rename -uid "3C12D633-F440-15A0-A549-0BB96A65BEFD";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "347BE57C-0F47-AAD7-2742-E58AC56025BC";
createNode displayLayer -n "defaultLayer";
	rename -uid "D67A4A69-7848-1603-41BC-E18426C80D09";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0B335E19-5348-CC8E-6052-4D8F24BFB1D8";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "8E1D062F-AC4D-036F-6922-C7BA59EC85A3";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "5F8D801F-5B47-1328-D602-C8A78725BF35";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FC7EC6E2-6B47-7AAD-5654-6A8C25AFD729";
...
createNode polyTweakUV -n "polyTweakUV60";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".uvtk";
	setAttr ".uvtk[126]" -type "float2" -0.00021712654 7.3489932e-06 ;
	setAttr ".uvtk[127]" -type "float2" -0.012967498 6.2513909e-06 ;
	setAttr ".uvtk[128]" -type "float2" -0.013133068 -1.1492805e-05 ;
	setAttr ".uvtk[129]" -type "float2" -0.00023622785 -7.5739226e-06 ;
...
createNode polyTweakUV -n "polyTweakUV61";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".uvtk";
	setAttr ".uvtk[126]" -type "float2" -0.013721901 -1.1798863e-08 ;
	setAttr ".uvtk[127]" -type "float2" -0.013979389 -5.5213405e-07 ;
	setAttr ".uvtk[128]" -type "float2" -0.0017371492 9.0891344e-06 ;
	setAttr ".uvtk[129]" -type "float2" -0.001900599 -9.9534764e-06 ;
...
createNode polyTweakUV -n "polyTweakUV62";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".uvtk";
	setAttr ".uvtk[134]" -type "float2" 0.00021712776 7.3489941e-06 ;
	setAttr ".uvtk[135]" -type "float2" 0.00023622916 -7.5739244e-06 ;
	setAttr ".uvtk[136]" -type "float2" 0.012967499 6.2513914e-06 ;
	setAttr ".uvtk[137]" -type "float2" 0.013133069 -1.1492807e-05 ;
...
createNode polyTweak -n "polyTweak70";
	...
	setAttr ".uopa" yes;
	setAttr -s 4 ".tk[92:93]" -type "float3"  0.20288646 0 0.36101627 0.20288646
		 0 0.36101627;
...
createNode polyTweak -n "polyTweak71";
	...
	setAttr ".uopa" yes;
	setAttr -s 4 ".tk";
	setAttr ".tk[90]" -type "float3" 0.40466356 0 0.39049244 ;
	setAttr ".tk[91]" -type "float3" 0.40466356 0 0.39049244 ;
...
createNode polyTweak -n "polyTweak76";
	...
	setAttr ".uopa" yes;
	setAttr -s 4 ".tk";
	setAttr ".tk[65]" -type "float3" 0.037269622 0.0046281815 0.090465665 ;
	setAttr ".tk[66]" -type "float3" 0.041642338 -0.13536453 0.090465665 ;
...
createNode polyTweak -n "polyTweak80";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[48]" -type "float3" 0.016839996 -0.13536453 0.036790222 ;
	setAttr ".tk[49]" -type "float3" 0.031083912 0.0046281815 0.036790222 ;
...
connectAttr "polySplit32.out" "pCylinder5Shape.i";
connectAttr "groupId14.id" "pCylinder5Shape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "pCylinder5Shape.iog.og[0].gco";
connectAttr "polyTweakUV71.uvtk[0]" "pCylinder5Shape.uvst[0].uvtw";
