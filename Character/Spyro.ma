...
//Name: Spyro.ma
//Last modified: Fri, Nov 24, 2017 02:32:15 PM
//Codeset: UTF-8
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -14.027510901098337 9.0966076015635089 29.911994170961155 ;
	setAttr ".r" -type "double3" -383.13835270320851 1776.1999999994346 2.6071269531626451e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "166AA723-174E-CEA8-97D6-D98553C1C617";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 30.159245346645239;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.26174584031105042 0 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	...
	setAttr ".pt[167]" -type "float3" 0.0129125 1.1449175e-16 -0.00096252351 ;
	setAttr ".pt[437]" -type "float3" -0.01020578 2.289835e-16 0.001103264 ;
	setAttr ".pt[439]" -type "float3" -0.013719152 0 -0.00044021997 ;
	setAttr ".pt[440]" -type "float3" -0.016278978 0 2.1382257e-05 ;
	setAttr ".pt[539]" -type "float3" -0.012542469 0 0.0082982322 ;
	setAttr ".pt[589]" -type "float3" 0.016209779 0 0 ;
	setAttr ".pt[591]" -type "float3" 0 0 0.0020061058 ;
	setAttr ".pt[592]" -type "float3" 0 -0.038465854 0 ;
	setAttr ".pt[594]" -type "float3" -0.0073608928 -0.025674315 0.00076364912 ;
	setAttr ".pt[595]" -type "float3" -0.00097220024 -0.032741733 0 ;
	setAttr ".pt[596]" -type "float3" -0.0047442946 0 0 ;
	setAttr ".pt[598]" -type "float3" 0.019446138 0 0.0020061058 ;
	setAttr ".pt[599]" -type "float3" 0.0030612957 0 -0.00065007166 ;
	setAttr ".pt[600]" -type "float3" -0.022560988 0.017208813 0.0021214003 ;
	setAttr ".pt[601]" -type "float3" -0.014552452 -0.013193762 -0.0060102749 ;
	setAttr ".pt[602]" -type "float3" -0.02854063 -0.02181826 -0.0041096476 ;
	setAttr ".pt[605]" -type "float3" 0 0.0059245974 0 ;
	setAttr ".pt[606]" -type "float3" 0 -0.0044449177 0 ;
	setAttr ".pt[607]" -type "float3" 0.022987928 0 -0.001083339 ;
	setAttr ".pt[609]" -type "float3" -0.022560988 0 0.0021214003 ;
	setAttr ".pt[610]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[611]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[612]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[613]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[614]" -type "float3" -0.0091208164 -0.014189375 0.0085027646 ;
	setAttr ".pt[615]" -type "float3" -0.013340749 -0.011089199 0.009364686 ;
	setAttr ".pt[616]" -type "float3" 0 0.0085249851 0.0085027646 ;
	setAttr ".pt[617]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[618]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[619]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[620]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[621]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[622]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[623]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[624]" -type "float3" 0 0.0085328445 0.0085027646 ;
	setAttr ".pt[625]" -type "float3" -0.0065046139 0 0.0090444693 ;
	setAttr ".pt[626]" -type "float3" -0.004501096 -0.014569785 0.010527101 ;
	setAttr ".pt[627]" -type "float3" 0.039984971 0 -0.0026741112 ;
	setAttr ".pt[628]" -type "float3" 0 0 -0.0026741112 ;
	setAttr ".pt[629]" -type "float3" 0.039984971 0 -0.0026741112 ;
	setAttr ".pt[630]" -type "float3" 0 0 -0.0026741112 ;
	setAttr ".pt[631]" -type "float3" -0.022550525 -0.012753854 -0.0026741112 ;
	setAttr ".pt[632]" -type "float3" -0.022550525 -0.013775943 -0.0026741121 ;
	setAttr ".pt[633]" -type "float3" 0 0 0.0051809852 ;
	setAttr ".pt[635]" -type "float3" -0.012654483 0 0.0011244973 ;
	setAttr ".pt[640]" -type "float3" -0.022560988 0 0.0021214003 ;
	setAttr ".pt[642]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[643]" -type "float3" -0.0064055515 0.014575145 0.0085027646 ;
	setAttr ".pt[644]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[645]" -type "float3" 0 0 0.0085027646 ;
	setAttr ".pt[646]" -type "float3" 0.006500009 0 0.010498664 ;
	setAttr ".pt[647]" -type "float3" 0.004061223 0 0.00081529672 ;
	setAttr ".dr" 1;
createNode transform -n "left";
	rename -uid "5F72245B-9044-5D1C-BE3E-BCB1C9F93009";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1000.1 -4.544025740972006 5.0189126987240247 ;
	setAttr ".r" -type "double3" 0 -89.999999999999986 0 ;
